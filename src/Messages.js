  ...
  render() {
          ...
          {this.state.chat[key].id === "human" ? (
            <div>
              <div className="from-me">
                <p>
                  {this.state.chat[key].text}
                  <span className="metadata">
                    <span className="time">
                      {this.state.chat[key].time === time
                        ? "just now"
                        : this.state.chat[key].time}
                    </span>
                  </span>
                </p>
              </div>
    ...
    return (
      <div className="Messages">
        <section>
          <TransitionGroup enter exit={false}>
            {items}
          </TransitionGroup>
        ...
        <div className="input-group">
          ...
          >
            <i className="fas fa-location-arrow" style={style_1}></i>
          </span>
        </div>
      </div>
    );
